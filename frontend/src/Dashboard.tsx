...
import HealthSearch from './HealthSearch'; // Import the new component
...
function Dashboard() {
  ...
  useEffect(() => {
    // Fetching logic is now simple again
    const fetchReadings = () => {
      setLoading(true);
  ...
  const latestTemp = readings.find(r => r.sensor_type === 'temperature')?.value.toFixed(1) + ' °C' || 'N/A';
  ...
  return (
    <div className="container-fluid py-4">
      ...
      <div className="row">
        <div className="col-md-6 mb-4">
          <StatCard title="Latest Temperature" value={latestTemp} icon="bi-thermometer-half" />
      ...
      {/* Health Search Component replaces the filters */}
      <HealthSearch />
            ...
            <div className="card-body">
              ...
              <div className="table-responsive">
                <table className="table table-hover">
                  ...
                  <tbody>
                    {loading ? <tr><td colSpan={4}>Loading...</td></tr> : readings.map(reading => (
                      <tr key={reading.id}>
